...
import { type ArticleRepositoryPort } from '../../../ports/outbound/persistence/account-repository.port.js';

import { type GetArticlesParams, GetArticlesUseCase } from '../get-accounts.use-case.js';
